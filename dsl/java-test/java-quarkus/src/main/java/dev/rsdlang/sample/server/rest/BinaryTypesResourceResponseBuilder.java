...
public class BinaryTypesResourceResponseBuilder {
	...
	public ResponseBuilder uploadMixed(UploadMixedResult.Data $result, String $contentType, String text, int number,
	...
	public ResponseBuilder uploadMixedOpt(UploadMixedResult.Data $result, String $contentType, Optional<String> text,
			OptionalInt number, Optional<SimpleRecord.Data> rec, Optional<List<String>> textList,
			Optional<List<Integer>> numberList, Optional<List<SimpleRecord.Data>> recList, Optional<RSDFile> dataFile,
	...
	public ResponseBuilder uploadMixedNil(UploadMixedResult.Data $result, String $contentType, Optional<String> text,
			OptionalInt number, Optional<SimpleRecord.Data> rec, Optional<List<String>> textList,
			Optional<List<Integer>> numberList, Optional<List<SimpleRecord.Data>> recList, Optional<RSDFile> dataFile,
			Optional<RSDBlob> dataBlob) {
		return Response.status(200)
	...
	public ResponseBuilder uploadMixedOptNil(UploadMixedResult.Data $result, String $contentType,
			_Base.Nillable<String> text, _Base.Nillable<Integer> number, _Base.Nillable<SimpleRecord.Data> rec,
	...
	public ResponseBuilder mixed(MixedResult.Data $result, String $contentType, String pathString, int pathNumber,
			String headerString, int headerNumber, SimpleRecord.Data headerRecord, String queryString, int queryNumber,
	...
	public ResponseBuilder twoBinariesAddition(List<Integer> $result, String $contentType, RSDBlob dataBlob,
			RSDFile dataFile) {
		return Response.status(200)
				.type($contentType)
				.entity(_RestUtils.toStreamOutput(
