...
public class PatchableRecord_Basic_List_OptionalDataImpl extends _BaseDataImpl implements PatchableRecord_Basic_List_Optional.Data {
	...
	public static PatchableRecord_Basic_List_Optional.Data of(JsonObject obj) {
		return new PatchableRecord_Basic_List_OptionalDataImpl(obj);
	}
	...
	public static class DataBuilderImpl implements PatchableRecord_Basic_List_Optional.DataBuilder {
		private JsonObjectBuilder $builder = Json.createObjectBuilder();

		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder key(String key) {
			$builder.add("key", key);
			return this;
		}

		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder version(String version) {
			$builder.add("version", version);
			return this;
		}

		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueBoolean(List<Boolean> valueBoolean) {
		...
		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueShort(List<Short> valueShort) {
			if (valueShort == null) {
				return this;
			}
		...
		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueInt(List<Integer> valueInt) {
			if (valueInt == null) {
				return this;
			}
		...
		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueLong(List<Long> valueLong) {
			if (valueLong == null) {
				return this;
			}
		...
		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueFloat(List<Float> valueFloat) {
			if (valueFloat == null) {
				return this;
			}
		...
		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueDouble(List<Double> valueDouble) {
			if (valueDouble == null) {
				return this;
			}
		...
		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueString(List<String> valueString) {
			if (valueString == null) {
				return this;
			}
		...
		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueLocalDate(List<LocalDate> valueLocalDate) {
		...
		@Override
		public PatchableRecord_Basic_List_Optional.DataBuilder valueLocalTime(List<LocalTime> valueLocalTime) {
		...
		public PatchableRecord_Basic_List_Optional.Data build() {
			return new PatchableRecord_Basic_List_OptionalDataImpl($builder.build());
		}
	}

	public static PatchableRecord_Basic_List_Optional.DataBuilder builder() {
