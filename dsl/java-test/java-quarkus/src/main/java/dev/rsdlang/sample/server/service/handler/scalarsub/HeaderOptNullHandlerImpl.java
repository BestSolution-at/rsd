...
@ApplicationScoped
public class HeaderOptNullHandlerImpl implements ScalarSubstition_ServiceServiceImpl.HeaderOptNullHandler {

    @Override
    public NilResult headerOptNull(BuilderFactory _factory, Nillable<MyRange> range) {
        if (range.isNull()) {
