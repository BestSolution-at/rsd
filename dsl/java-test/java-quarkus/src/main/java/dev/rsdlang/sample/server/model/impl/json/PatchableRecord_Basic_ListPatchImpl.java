...
public class PatchableRecord_Basic_ListPatchImpl extends _BaseDataImpl implements PatchableRecord_Basic_List.Patch {
	...
	public Optional<ValueLocalTimeChange> valueLocalTime() {
		return _JsonUtils.mapOptObject(data, "valueLocalTime", o -> _ChangeSupport.of(o, "@type",
	...
	public Optional<ValueOffsetDateTimeChange> valueOffsetDateTime() {
		return _JsonUtils.mapOptObject(data, "valueOffsetDateTime", o -> _ChangeSupport.of(o, "@type",
	...
	public static class PatchBuilderImpl implements PatchableRecord_Basic_List.PatchBuilder {
		...
		@Override
		public PatchableRecord_Basic_List.PatchBuilder valueLocalTime(ValueLocalTimeChange valueLocalTime) {
			$builder.add("valueLocalTime", ((_BaseDataImpl) valueLocalTime).data);
			return this;
		}

		public PatchableRecord_Basic_List.PatchBuilder valueLocalTime(List<LocalTime> additions,
		...
		public PatchableRecord_Basic_List.PatchBuilder valueLocalTime(List<LocalTime> elements) {
			var $changeBuilder = Json.createObjectBuilder();
			$changeBuilder.add("@type", "replace");
			$changeBuilder.add("elements", _JsonUtils.toJsonLiteralArray(elements));
			$builder.add("valueLocalTime", $changeBuilder.build());
		...
		@Override
		public PatchableRecord_Basic_List.PatchBuilder valueOffsetDateTime(
				ValueOffsetDateTimeChange valueOffsetDateTime) {
			$builder.add("valueOffsetDateTime", ((_BaseDataImpl) valueOffsetDateTime).data);
			return this;
		}

		public PatchableRecord_Basic_List.PatchBuilder valueOffsetDateTime(List<OffsetDateTime> additions,
		...
		public PatchableRecord_Basic_List.PatchBuilder valueOffsetDateTime(List<OffsetDateTime> elements) {
			var $changeBuilder = Json.createObjectBuilder();
			$changeBuilder.add("@type", "replace");
			$changeBuilder.add("elements", _JsonUtils.toJsonLiteralArray(elements));
			$builder.add("valueOffsetDateTime", $changeBuilder.build());
