...
@ApplicationScoped
public class PostListOptNullHandlerImpl implements EnumSubstition_ServiceServiceImpl.PostListOptNullHandler {

    @Override
    public NilResult postListOptNull(BuilderFactory _factory, Nillable<List<DayOfWeek>> dayOfWeek) {
        if (dayOfWeek.isNull()) {
