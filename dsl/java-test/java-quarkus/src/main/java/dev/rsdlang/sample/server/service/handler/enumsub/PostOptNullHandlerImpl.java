...
@ApplicationScoped
public class PostOptNullHandlerImpl implements EnumSubstition_ServiceServiceImpl.PostOptNullHandler {

    @Override
    public NilResult postOptNull(BuilderFactory _factory, Nillable<DayOfWeek> dayOfWeek) {
        if (dayOfWeek.isNull()) {
