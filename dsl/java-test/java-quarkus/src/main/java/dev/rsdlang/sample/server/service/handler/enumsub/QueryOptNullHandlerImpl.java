...
@ApplicationScoped
public class QueryOptNullHandlerImpl implements EnumSubstition_ServiceServiceImpl.QueryOptNullHandler {

    @Override
    public NilResult queryOptNull(BuilderFactory _factory, Nillable<DayOfWeek> dayOfWeek) {
        if (dayOfWeek.isNull()) {
