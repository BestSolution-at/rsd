...
public class PatchableRecord_Basic_ListPatchImpl extends _BaseDataImpl implements PatchableRecord_Basic_List.Patch {
	...
	public Optional<ValueLocalTimeChange> valueLocalTime() {
		return _JsonUtils.mapOptObject(data, "valueLocalTime", o -> _ChangeSupport.of(o, "@type", ValueLocalTimeSetChangeImpl::new, ValueLocalTimeMergeChangeImpl::new));
	}

	public Optional<ValueOffsetDateTimeChange> valueOffsetDateTime() {
		return _JsonUtils.mapOptObject(data, "valueOffsetDateTime", o -> _ChangeSupport.of(o, "@type", ValueOffsetDateTimeSetChangeImpl::new, ValueOffsetDateTimeMergeChangeImpl::new));
	}
	...
	public static class PatchBuilderImpl implements PatchableRecord_Basic_List.PatchBuilder {
		...
		public PatchableRecord_Basic_List.PatchBuilder valueLocalTime(List<LocalTime> additions, List<LocalTime> removals) {
			var $changeBuilder = Json.createObjectBuilder();
			$changeBuilder.add("@type", "merge");
			$changeBuilder.add("additions", _JsonUtils.toJsonLiteralArray(additions));
			$changeBuilder.add("removals", _JsonUtils.toJsonLiteralArray(removals));
		...
		@Override
		public PatchableRecord_Basic_List.PatchBuilder valueOffsetDateTime(ValueOffsetDateTimeChange valueOffsetDateTime) {
			$builder.add("valueOffsetDateTime", ((_BaseDataImpl) valueOffsetDateTime).data);
			return this;
		}

		public PatchableRecord_Basic_List.PatchBuilder valueOffsetDateTime(List<OffsetDateTime> additions, List<OffsetDateTime> removals) {
			var $changeBuilder = Json.createObjectBuilder();
			$changeBuilder.add("@type", "merge");
			$changeBuilder.add("additions", _JsonUtils.toJsonLiteralArray(additions));
			$changeBuilder.add("removals", _JsonUtils.toJsonLiteralArray(removals));
