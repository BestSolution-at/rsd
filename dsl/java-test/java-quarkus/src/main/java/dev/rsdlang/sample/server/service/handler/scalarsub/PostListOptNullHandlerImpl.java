...
@ApplicationScoped
public class PostListOptNullHandlerImpl implements ScalarSubstition_ServiceServiceImpl.PostListOptNullHandler {

    @Override
    public NilResult postListOptNull(BuilderFactory _factory, Nillable<List<MyRange>> range) {
        if (range.isNull()) {
