...
public interface PatchableRecordWithUnion {
	...
	public interface Patch extends _Base.BaseData, PatchableRecordWithUnion {
		...
		public Optional<dev.rsdlang.sample.server.model.PatchableUnion> value();

		public _Base.Nillable<dev.rsdlang.sample.server.model.PatchableUnion> value_Null();

		public _Base.Nillable<dev.rsdlang.sample.server.model.PatchableUnion> value_Opt();

		public _Base.Nillable<dev.rsdlang.sample.server.model.PatchableUnion> value_Opt_Null();
