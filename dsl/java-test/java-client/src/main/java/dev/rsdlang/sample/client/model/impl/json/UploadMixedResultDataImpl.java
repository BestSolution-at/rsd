...
public class UploadMixedResultDataImpl extends _BaseDataImpl implements UploadMixedResult.Data {
	...
	@Override
	public _Base.Nillable<DayOfWeek> dayOfWeek() {
		return _JsonUtils.mapNilLiteral(data, "dayOfWeek", _EnumSupport::DayOfWeekFromJson);
	}
	...
	@Override
	public _Base.Nillable<List<Month>> monthList() {
		return _JsonUtils.mapNilLiterals(data, "monthList", _EnumSupport::MonthFromJson);
	}
	...
	public static class DataBuilderImpl implements UploadMixedResult.DataBuilder {
		...
		@Override
		public UploadMixedResult.DataBuilder dayOfWeek(DayOfWeek dayOfWeek) {
			if (dayOfWeek == null) {
		...
		@Override
		public UploadMixedResult.DataBuilder monthList(List<Month> monthList) {
			if (monthList == null) {
				$builder.addNull("monthList");
				return this;
			}
