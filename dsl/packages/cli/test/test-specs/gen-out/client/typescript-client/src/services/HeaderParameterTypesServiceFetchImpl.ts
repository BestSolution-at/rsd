...
export function createHeaderParameterTypesService(
...
function fnSimpleBooleanHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleBooleanHeaderParam'] {
	...
	return async (headerValue: RSDBoolean) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDBoolean);
...
function fnSimpleBooleanHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleBooleanHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDBoolean) => {
		try {
...
function fnSimpleBooleanHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleBooleanHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleBooleanHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleBooleanHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDBoolean | null) => {
		try {
...
function fnSimpleShortHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleShortHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDShort) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDShort);
...
function fnSimpleShortHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleShortHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDShort) => {
		try {
...
function fnSimpleShortHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleShortHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleShortHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleShortHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDShort | null) => {
		try {
...
function fnSimpleIntHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleIntHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDInt) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDInt);
...
function fnSimpleIntHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleIntHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDInt) => {
		try {
...
function fnSimpleIntHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleIntHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleIntHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleIntHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDInt | null) => {
		try {
...
function fnSimpleLongHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLongHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLong) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isNumeric);
...
function fnSimpleLongHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLongHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLong) => {
		try {
...
function fnSimpleLongHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLongHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleLongHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLongHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLong | null) => {
		try {
...
function fnSimpleFloatHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleFloatHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDFloat) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDFloat);
...
function fnSimpleFloatHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleFloatHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDFloat) => {
		try {
...
function fnSimpleFloatHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleFloatHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleFloatHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleFloatHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDFloat | null) => {
		try {
...
function fnSimpleDoubleHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleDoubleHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDDouble) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDDouble);
...
function fnSimpleDoubleHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleDoubleHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDDouble) => {
		try {
...
function fnSimpleDoubleHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleDoubleHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleDoubleHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleDoubleHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDDouble | null) => {
		try {
...
function fnSimpleStringHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleStringHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleStringHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleStringHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDString) => {
		try {
...
function fnSimpleStringHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleStringHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleStringHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleStringHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDString | null) => {
		try {
...
function fnSimpleLocalDateHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalDateHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLocalDate) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDLocalDate);
...
function fnSimpleLocalDateHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalDateHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalDate) => {
		try {
...
function fnSimpleLocalDateHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalDateHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleLocalDateHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalDateHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalDate | null) => {
		try {
...
function fnSimpleLocalDateTimeHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalDateTimeHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLocalDateTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDLocalDateTime);
...
function fnSimpleLocalDateTimeHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalDateTimeHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalDateTime) => {
		try {
...
function fnSimpleLocalDateTimeHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalDateTimeHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleLocalDateTimeHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalDateTimeHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalDateTime | null) => {
		try {
...
function fnSimpleLocalTimeHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalTimeHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLocalTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDLocalTime);
				return safeExecute(api.result.OK($data), () => onSuccess?.('simpleLocalTimeHeaderParam', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLocalTimeHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalTimeHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('simpleLocalTimeHeaderParamOpt', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLocalTimeHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalTimeHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLocalTime | null) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('simpleLocalTimeHeaderParamNil', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLocalTimeHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleLocalTimeHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalTime | null) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('simpleLocalTimeHeaderParamOptNil', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleOffsetDateTimeHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleOffsetDateTimeHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDOffsetDateTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDOffsetDateTime);
...
function fnSimpleOffsetDateTimeHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleOffsetDateTimeHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDOffsetDateTime) => {
		try {
...
function fnSimpleOffsetDateTimeHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleOffsetDateTimeHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleOffsetDateTimeHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleOffsetDateTimeHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDOffsetDateTime | null) => {
		try {
...
function fnSimpleZonedDateTimeHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleZonedDateTimeHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDZonedDateTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDZonedDateTime);
...
function fnSimpleZonedDateTimeHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleZonedDateTimeHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDZonedDateTime) => {
		try {
...
function fnSimpleZonedDateTimeHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleZonedDateTimeHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleZonedDateTimeHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleZonedDateTimeHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDZonedDateTime | null) => {
		try {
...
function fnSimpleScalarHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleScalarHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleScalarHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleScalarHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: string) => {
		try {
...
function fnSimpleScalarHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleScalarHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleScalarHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleScalarHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: string | null) => {
		try {
...
function fnSimpleEnumHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleEnumHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleEnumHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleEnumHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: api.model.SampleEnum) => {
		try {
...
function fnSimpleEnumHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleEnumHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleEnumHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleEnumHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: api.model.SampleEnum | null) => {
		try {
...
function fnSimpleInlineEnumHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleInlineEnumHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleInlineEnumHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleInlineEnumHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: 'A' | 'B') => {
		try {
...
function fnSimpleInlineEnumHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleInlineEnumHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleInlineEnumHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['simpleInlineEnumHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: 'C' | 'D' | null) => {
		try {
...
function fnMultiHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['multiHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnMultiHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['multiHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (valueA?: RSDString, valueB?: RSDInt) => {
		try {
...
function fnMultiHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['multiHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnMultiHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['multiHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (valueA?: RSDString | null, valueB?: RSDInt | null) => {
		try {
...
function fnRecordHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['recordHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: api.model.SimpleRecord) => {
		try {
			...
			$headers.append(
				'headerValue',
				encodeBase64(encodeValue(encodingType(props), api.model.SimpleRecordToJSON(headerValue))),
			);
			$init.headers = $headers;
...
function fnRecordHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['recordHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: api.model.SimpleRecord) => {
		try {
...
function fnRecordHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['recordHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnRecordHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.HeaderParameterTypesService['recordHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: api.model.SimpleRecord | null) => {
		try {
...
function fnMixed(props: ServiceProps<api.service.ErrorType>): api.service.HeaderParameterTypesService['mixed'] {
	...
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (
		pathString: RSDString,
		pathNumber: RSDInt,
		headerString: RSDString,
		headerNumber: RSDInt,
		headerRecord: api.model.SimpleRecord,
		body: api.model.SimpleRecord,
		queryString: RSDString,
		queryNumber: RSDDouble,
		...
		try {
			...
			$headers.append(
				'headerRecord',
				encodeBase64(encodeValue(encodingType(props), api.model.SimpleRecordToJSON(headerRecord))),
			);
			$init.headers = $headers;
			...
			$param.append(
				'queryRecord',
				encodeBase64(encodeValue(encodingType(props), api.model.SimpleRecordToJSON(queryRecord))),
			);
