...
function fnGetOffsetDateTime(
	props: ServiceProps<api.service.ErrorType>,
): api.service.SampleServiceService['getOffsetDateTime'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($data), () => onSuccess?.('getOffsetDateTime', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnGetSimpleErrorWithValue(
	props: ServiceProps<api.service.ErrorType>,
): api.service.SampleServiceService['getSimpleErrorWithValue'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onError, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
			...
			if ($response.status === 204) {
				return safeExecute(api.result.OK(api.result.Void), () =>
					onSuccess?.('getSimpleErrorWithValue', api.result.Void),
				);
			} else if ($response.status === 400) {
				const $data = await decodeResponse($response, api.utils.isRecord);
...
function fnGetSimpleErrorInt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.SampleServiceService['getSimpleErrorInt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onError, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnGetSimpleErrorBoolean(
	props: ServiceProps<api.service.ErrorType>,
): api.service.SampleServiceService['getSimpleErrorBoolean'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onError, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnGetSimpleErrorEnum(
	props: ServiceProps<api.service.ErrorType>,
): api.service.SampleServiceService['getSimpleErrorEnum'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onError, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnGetSimpleErrorScalar(
	props: ServiceProps<api.service.ErrorType>,
): api.service.SampleServiceService['getSimpleErrorScalar'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onError, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnGetSimpleErrorUnion(
	props: ServiceProps<api.service.ErrorType>,
): api.service.SampleServiceService['getSimpleErrorUnion'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onError, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
