...
import { isLocalDate, isLocalDateTime, isLocalTime, isOffsetDateTime, isRSDBoolean, isRSDDouble, isRSDFloat, isRSDInt, isRSDLong, isRSDShort, isRSDString, isZonedDateTime, type RSDString } from '../model/Builtins.js';
