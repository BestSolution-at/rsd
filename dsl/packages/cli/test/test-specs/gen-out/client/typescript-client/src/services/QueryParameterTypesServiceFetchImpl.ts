...
function fnSimpleLocalTimeQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.QueryParameterTypesService['simpleLocalTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleLocalTimeQueryParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.QueryParameterTypesService['simpleLocalTimeQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDLocalTime) => {
		try {
...
function fnSimpleOffsetDateTimeQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.QueryParameterTypesService['simpleOffsetDateTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleOffsetDateTimeQueryParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.QueryParameterTypesService['simpleOffsetDateTimeQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDOffsetDateTime) => {
		try {
...
function fnRecordQueryParam(
	...
	return async (queryValue: api.model.SimpleRecord) => {
		try {
			...
			$param.append(
				'queryValue',
				encodeBase64(encodeValue(encodingType(props), api.model.SimpleRecordToJSON(queryValue))),
			);
