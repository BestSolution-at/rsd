...
import { decodeResponse, encodeBase64, encodeValue, encodingType, safeExecute, type ServiceProps } from './_fetch-type-utils.js';
...
export function createQueryParameterTypesService(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService {
	return {
...
function fnSimpleBooleanQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleBooleanQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDBoolean) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleBooleanQueryParam', $result));
			}
...
function fnSimpleBooleanQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleBooleanQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDBoolean) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleBooleanQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleShortQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleShortQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDShort) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleShortQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleShortQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleShortQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDShort) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleShortQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleIntQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleIntQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDInt) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleIntQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleIntQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleIntQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDInt) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleIntQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLongQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleLongQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDLong) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleLongQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLongQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleLongQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDLong) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleLongQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleFloatQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleFloatQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDFloat) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleFloatQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleFloatQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleFloatQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDFloat) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleFloatQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleDoubleQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleDoubleQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDDouble) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleDoubleQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleDoubleQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleDoubleQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDDouble) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleDoubleQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleStringQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleStringQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDString) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleStringQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleStringQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleStringQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDString) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleStringQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLocalDateQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleLocalDateQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDLocalDate) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleLocalDateQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLocalDateQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleLocalDateQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDLocalDate) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleLocalDateQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLocalDateTimeQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleLocalDateTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDLocalDateTime) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleLocalDateTimeQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLocalDateTimeQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleLocalDateTimeQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDLocalDateTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleLocalDateTimeQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleLocalTimeQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleLocalTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDLocalTime) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleLocalTimeQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue?: RSDLocalTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleLocalTimeQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleOffsetDateTimeQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleOffsetDateTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDOffsetDateTime) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleOffsetDateTimeQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue?: RSDOffsetDateTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleOffsetDateTimeQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleZonedDateTimeQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleZonedDateTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDZonedDateTime) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleZonedDateTimeQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleZonedDateTimeQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleZonedDateTimeQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: RSDZonedDateTime) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleZonedDateTimeQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue?: api.model.ZoneId) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleScalarQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleEnumQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleEnumQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: api.model.SampleEnum) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleEnumQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnSimpleEnumQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['simpleEnumQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: api.model.SampleEnum) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('simpleEnumQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (valueA: RSDString, valueB: RSDInt) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isString);
				const $result = RSDStringFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('multiQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (valueA?: RSDString, valueB?: RSDInt) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isString);
				const $result = RSDStringFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('multiQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnRecordQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['recordQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: api.model.SimpleRecord) => {
		try {
			...
			const $param = new URLSearchParams();
			$param.append('queryValue', encodeBase64(encodeValue(encodingType(props), api.model.SimpleRecordToJSON(queryValue))));
...
function fnRecordQueryParamOpt(props: ServiceProps<api.service.ErrorType>): api.service.QueryParameterTypesService['recordQueryParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue?: api.model.SimpleRecord) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.utils.isString);
				const $result = api.model.NilResultFromJSON($data);
				return safeExecute(api.result.OK($result), () => onSuccess?.('recordQueryParamOpt', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
