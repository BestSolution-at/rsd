...
import { checkOptProp, checkProp, createReplaceAddRemoveGuard, createTypedArrayGuard, isBoolean, isListReplace, isNumber, isRecord, isString, type ListMergeAddRemove, ListMergeAddRemoveFromJSON, type ListReplace, ListReplaceFromJSON, noopMap, propListValue, propMappedValue, propValue } from '../_type-utils.js';
