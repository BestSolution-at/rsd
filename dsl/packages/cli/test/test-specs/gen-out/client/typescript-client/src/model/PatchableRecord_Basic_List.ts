...
import {
	...
	isRecord,
	isString,
	type ListMergeAddRemove,
	ListMergeAddRemoveFromJSON,
	type ListReplace,
	ListReplaceFromJSON,
	noopMap,
	propListValue,
...
export function PatchableRecord_Basic_ListPatchFromJSON(
	$value: Record<string, unknown>,
): PatchableRecord_Basic_ListPatch {
	const key = propValue('key', $value, isString);
	const version = propValue('version', $value, isString);
	const valueBoolean = propMappedValue(
		'valueBoolean',
		$value,
		isRecord,
		v =>
			isListReplace(v, isBoolean)
				? ListReplaceFromJSON(v, isBoolean, noopMap)
				: ListMergeAddRemoveFromJSON(v, isBoolean, noopMap, isBoolean, noopMap),
		'optional',
	);
	const valueShort = propMappedValue(
		'valueShort',
		$value,
		isRecord,
		v =>
			isListReplace(v, isNumber)
				? ListReplaceFromJSON(v, isNumber, noopMap)
				: ListMergeAddRemoveFromJSON(v, isNumber, noopMap, isNumber, noopMap),
		'optional',
	);
	const valueInt = propMappedValue(
		'valueInt',
		$value,
		isRecord,
		v =>
	...
	const valueLong = propMappedValue(
		'valueLong',
		$value,
		isRecord,
		v =>
	...
	const valueFloat = propMappedValue(
		'valueFloat',
		$value,
		isRecord,
		v =>
	...
	const valueDouble = propMappedValue(
		'valueDouble',
		$value,
		isRecord,
		v =>
	...
	const valueString = propMappedValue(
		'valueString',
		$value,
		isRecord,
		v =>
			isListReplace(v, isString)
				? ListReplaceFromJSON(v, isString, noopMap)
				: ListMergeAddRemoveFromJSON(v, isString, noopMap, isString, noopMap),
		'optional',
	);
	const valueLocalDate = propMappedValue(
		'valueLocalDate',
		$value,
		isRecord,
		v =>
	...
	const valueLocalDateTime = propMappedValue(
		'valueLocalDateTime',
		$value,
		isRecord,
		v =>
	...
	const valueZonedDateTime = propMappedValue(
		'valueZonedDateTime',
		$value,
		isRecord,
		v =>
...
export function PatchableRecord_Basic_ListPatchToJSON(
	$value: PatchableRecord_Basic_ListPatch,
