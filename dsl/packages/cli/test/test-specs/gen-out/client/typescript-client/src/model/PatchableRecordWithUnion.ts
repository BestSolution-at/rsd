...
import { isPatchableUnion, isPatchableUnionPatch, type PatchableUnion, PatchableUnionFromJSON, PatchableUnionOrPatchFromJSON, PatchableUnionOrPatchToJSON, type PatchableUnionPatch, PatchableUnionPatchFromJSON, PatchableUnionPatchToJSON, PatchableUnionToJSON } from './PatchableUnion.js';
import { checkOptProp, checkProp, createListMergeUpdateRemoveToJSON, createListReplaceToJSON, createReplaceAddUpdateRemoveGuard, createTypedArrayGuard, isListReplace, isNull, isRecord, isString, isUndefined, type ListMergeAddUpdateRemove, ListMergeAddUpdateRemoveFromJSON, type ListReplace, ListReplaceFromJSON, noopMap, propMappedListValue, propMappedValue, ReplaceOrMergeToJSON } from '../_type-utils.js';
