	...
	return async (queryValue: RSDBoolean[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listBooleanQueryParam', $result));
			}
	...
	return async (queryValue: RSDShort[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listShortQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDInt[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listIntQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDFloat[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listFloatQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDDouble[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listDoubleQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDString[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listStringQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDLocalDate[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listLocalDateQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDLocalDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listLocalDateTimeQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDLocalTime[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listLocalTimeQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDOffsetDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listOffsetDateTimeQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (queryValue: RSDZonedDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listZonedDateTimeQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
	...
	return async (valueA: RSDString[], valueB: RSDInt[], valueC: api.model.SimpleRecord[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listMultiQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnListRecordQueryParam(props: ServiceProps<api.service.ErrorType>): api.service.ListQueryParameterTypesService['listRecordQueryParam'] {
	...
	return async (queryValue: api.model.SimpleRecord[]) => {
		try {
			...
			const $param = new URLSearchParams();
			queryValue.forEach($entry => {
				$param.append('queryValue', encodeBase64(encodeValue(encodingType(props), api.model.SimpleRecordToJSON($entry))));
			});
