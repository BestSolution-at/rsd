...
export function createListQueryParameterTypesService(
...
function fnListBooleanQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listBooleanQueryParam'] {
...
function fnListShortQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listShortQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListIntQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listIntQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLongQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listLongQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (queryValue: RSDLong[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($result), () => onSuccess?.('listLongQueryParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnListFloatQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listFloatQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListDoubleQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listDoubleQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListStringQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listStringQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalDateQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listLocalDateQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalDateTimeQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listLocalDateTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalTimeQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listLocalTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListOffsetDateTimeQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listOffsetDateTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListZonedDateTimeQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listZonedDateTimeQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListScalarQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listScalarQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListEnumQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listEnumQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListInlineEnumQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listInlineEnumQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListMultiQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listMultiQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListRecordQueryParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListQueryParameterTypesService['listRecordQueryParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
