...
export function createListSampleServiceService(
...
function fnListBoolean(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListSampleServiceService['listBoolean'] {
...
function fnListLocalDate(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListSampleServiceService['listLocalDate'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnListLocalDateTime(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListSampleServiceService['listLocalDateTime'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnListLocalTime(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListSampleServiceService['listLocalTime'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnListOffsetDateTime(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListSampleServiceService['listOffsetDateTime'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTime', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnListZonedDateTime(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListSampleServiceService['listZonedDateTime'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnListSimpleRecord(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListSampleServiceService['listSimpleRecord'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async () => {
		try {
...
function fnListSimpleRecordWithError(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListSampleServiceService['listSimpleRecordWithError'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
