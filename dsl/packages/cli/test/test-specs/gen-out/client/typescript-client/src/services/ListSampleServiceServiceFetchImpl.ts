...
import { isLocalDate, isLocalDateTime, isLocalTime, isOffsetDateTime, isRSDBoolean, isRSDDouble, isRSDFloat, isRSDInt, isRSDLong, isRSDShort, isRSDString, isZonedDateTime } from '../model/Builtins.js';
