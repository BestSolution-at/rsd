...
function fnListLocalDateHeaderParam(props: ServiceProps<api.service.ErrorType>): api.service.ListHeaderParameterTypesService['listLocalDateHeaderParam'] {
	...
	return async (headerValue: RSDLocalDate[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isLocalDate));
...
function fnListLocalDateTimeHeaderParam(props: ServiceProps<api.service.ErrorType>): api.service.ListHeaderParameterTypesService['listLocalDateTimeHeaderParam'] {
	...
	return async (headerValue: RSDLocalDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isLocalDateTime));
...
function fnListLocalTimeHeaderParam(props: ServiceProps<api.service.ErrorType>): api.service.ListHeaderParameterTypesService['listLocalTimeHeaderParam'] {
	...
	return async (headerValue: RSDLocalTime[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isLocalTime));
...
function fnListOffsetDateTimeHeaderParam(props: ServiceProps<api.service.ErrorType>): api.service.ListHeaderParameterTypesService['listOffsetDateTimeHeaderParam'] {
	...
	return async (headerValue: RSDOffsetDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isOffsetDateTime));
...
function fnListZonedDateTimeHeaderParam(props: ServiceProps<api.service.ErrorType>): api.service.ListHeaderParameterTypesService['listZonedDateTimeHeaderParam'] {
	...
	return async (headerValue: RSDZonedDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isZonedDateTime));
