...
import {
	...
	type RSDInt,
	type RSDLocalDate,
	type RSDLocalDateTime,
	type RSDLocalTime,
	type RSDLong,
	type RSDOffsetDateTime,
	type RSDShort,
	type RSDString,
	type RSDZonedDateTime,
...
export function createListHeaderParameterTypesService(
	...
	return {
		...
		listOffsetDateTimeHeaderParam: fnListOffsetDateTimeHeaderParam(props),
		listOffsetDateTimeHeaderParamOpt: fnListOffsetDateTimeHeaderParamOpt(props),
		listOffsetDateTimeHeaderParamNil: fnListOffsetDateTimeHeaderParamNil(props),
		listOffsetDateTimeHeaderParamOptNil: fnListOffsetDateTimeHeaderParamOptNil(props),
...
function fnListBooleanHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listBooleanHeaderParam'] {
	...
	return async (headerValue: RSDBoolean[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDBoolean));
...
function fnListBooleanHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listBooleanHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDBoolean[]) => {
		try {
...
function fnListBooleanHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listBooleanHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListBooleanHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listBooleanHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDBoolean[] | null) => {
		try {
...
function fnListShortHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listShortHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDShort[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDShort));
...
function fnListShortHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listShortHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDShort[]) => {
		try {
...
function fnListShortHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listShortHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListShortHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listShortHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDShort[] | null) => {
		try {
...
function fnListIntHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listIntHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDInt[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDInt));
...
function fnListIntHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listIntHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDInt[]) => {
		try {
...
function fnListIntHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listIntHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListIntHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listIntHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDInt[] | null) => {
		try {
...
function fnListLongHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLongHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLong[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, api.utils.isNumeric));
				const $result = $data.map(RSDLongFromJSON);
				return safeExecute(api.result.OK($result), () => onSuccess?.('listLongHeaderParam', $result));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnListLongHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLongHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLong[]) => {
		try {
...
function fnListLongHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLongHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLongHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLongHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLong[] | null) => {
		try {
...
function fnListFloatHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listFloatHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDFloat[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDFloat));
...
function fnListFloatHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listFloatHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDFloat[]) => {
		try {
...
function fnListFloatHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listFloatHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListFloatHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listFloatHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDFloat[] | null) => {
		try {
...
function fnListDoubleHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listDoubleHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDDouble[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDDouble));
...
function fnListDoubleHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listDoubleHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDDouble[]) => {
		try {
...
function fnListDoubleHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listDoubleHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListDoubleHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listDoubleHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDDouble[] | null) => {
		try {
...
function fnListStringHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listStringHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDString[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDString));
...
function fnListStringHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listStringHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDString[]) => {
		try {
...
function fnListStringHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listStringHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListStringHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listStringHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDString[] | null) => {
		try {
...
function fnListLocalDateHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalDateHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLocalDate[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDLocalDate));
...
function fnListLocalDateHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalDateHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalDate[]) => {
		try {
...
function fnListLocalDateHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalDateHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalDateHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalDateHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalDate[] | null) => {
		try {
...
function fnListLocalDateTimeHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalDateTimeHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLocalDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDLocalDateTime));
...
function fnListLocalDateTimeHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalDateTimeHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalDateTime[]) => {
		try {
...
function fnListLocalDateTimeHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalDateTimeHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalDateTimeHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalDateTimeHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalDateTime[] | null) => {
		try {
...
function fnListLocalTimeHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalTimeHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDLocalTime[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDLocalTime));
...
function fnListLocalTimeHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalTimeHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalTime[]) => {
		try {
...
function fnListLocalTimeHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalTimeHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalTimeHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listLocalTimeHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDLocalTime[] | null) => {
		try {
...
function fnListOffsetDateTimeHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listOffsetDateTimeHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDOffsetDateTime[]) => {
		try {
			const $init = (await preFetch?.('listOffsetDateTimeHeaderParam')) ?? {};
			const $headers = new Headers($init.headers ?? {});
			$headers.append('Accept', encodingType(props));
			$headers.append('Content-Type', encodingType(props));
			headerValue.forEach($entry => {
			...
			const $path = `${baseUrl}/api/listheaderparametertypes/listOffsetDateTimeHeaderParam`;
			const $response = await fetchAPI($path, { ...$init, method: 'GET' });

			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDOffsetDateTime));
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTimeHeaderParam', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
			onCatch?.('listOffsetDateTimeHeaderParam', e);
			const ee = e instanceof Error ? e : new Error('', { cause: e });
			const err = { _type: '_Native', message: ee.message, error: ee } as const;
			return api.result.ERR(err);
		} finally {
			final?.('listOffsetDateTimeHeaderParam');
		}
	};
}

function fnListOffsetDateTimeHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listOffsetDateTimeHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDOffsetDateTime[]) => {
		try {
			const $init = (await preFetch?.('listOffsetDateTimeHeaderParamOpt')) ?? {};
			const $headers = new Headers($init.headers ?? {});
			$headers.append('Accept', encodingType(props));
			$headers.append('Content-Type', encodingType(props));
			if (headerValue !== undefined) {
			...
			const $path = `${baseUrl}/api/listheaderparametertypes/listOffsetDateTimeHeaderParamOpt`;
			const $response = await fetchAPI($path, { ...$init, method: 'GET' });

			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTimeHeaderParamOpt', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
			onCatch?.('listOffsetDateTimeHeaderParamOpt', e);
			const ee = e instanceof Error ? e : new Error('', { cause: e });
			const err = { _type: '_Native', message: ee.message, error: ee } as const;
			return api.result.ERR(err);
		} finally {
			final?.('listOffsetDateTimeHeaderParamOpt');
		}
	};
}

function fnListOffsetDateTimeHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listOffsetDateTimeHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDOffsetDateTime[] | null) => {
		try {
			const $init = (await preFetch?.('listOffsetDateTimeHeaderParamNil')) ?? {};
			const $headers = new Headers($init.headers ?? {});
			$headers.append('Accept', encodingType(props));
			$headers.append('Content-Type', encodingType(props));
			if (headerValue !== null) {
			...
			const $path = `${baseUrl}/api/listheaderparametertypes/listOffsetDateTimeHeaderParamNil`;
			const $response = await fetchAPI($path, { ...$init, method: 'GET' });

			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTimeHeaderParamNil', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
			onCatch?.('listOffsetDateTimeHeaderParamNil', e);
			const ee = e instanceof Error ? e : new Error('', { cause: e });
			const err = { _type: '_Native', message: ee.message, error: ee } as const;
			return api.result.ERR(err);
		} finally {
			final?.('listOffsetDateTimeHeaderParamNil');
		}
	};
}

function fnListOffsetDateTimeHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listOffsetDateTimeHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDOffsetDateTime[] | null) => {
		try {
			const $init = (await preFetch?.('listOffsetDateTimeHeaderParamOptNil')) ?? {};
			const $headers = new Headers($init.headers ?? {});
			$headers.append('Accept', encodingType(props));
			$headers.append('Content-Type', encodingType(props));
			if (headerValue !== undefined && headerValue !== null) {
			...
			const $path = `${baseUrl}/api/listheaderparametertypes/listOffsetDateTimeHeaderParamOptNil`;
			const $response = await fetchAPI($path, { ...$init, method: 'GET' });

			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTimeHeaderParamOptNil', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
			onCatch?.('listOffsetDateTimeHeaderParamOptNil', e);
			const ee = e instanceof Error ? e : new Error('', { cause: e });
			const err = { _type: '_Native', message: ee.message, error: ee } as const;
			return api.result.ERR(err);
		} finally {
			final?.('listOffsetDateTimeHeaderParamOptNil');
		}
	};
}

function fnListZonedDateTimeHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listZonedDateTimeHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: RSDZonedDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v => api.utils.isTypedArray(v, isRSDZonedDateTime));
...
function fnListZonedDateTimeHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listZonedDateTimeHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDZonedDateTime[]) => {
		try {
...
function fnListZonedDateTimeHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listZonedDateTimeHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListZonedDateTimeHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listZonedDateTimeHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: RSDZonedDateTime[] | null) => {
		try {
...
function fnListScalarHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listScalarHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListScalarHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listScalarHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: string[]) => {
		try {
...
function fnListScalarHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listScalarHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListScalarHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listScalarHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: string[] | null) => {
		try {
...
function fnListEnumHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listEnumHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListEnumHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listEnumHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: api.model.SampleEnum[]) => {
		try {
...
function fnListEnumHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listEnumHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListEnumHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listEnumHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: api.model.SampleEnum[] | null) => {
		try {
...
function fnListInlineEnumHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listInlineEnumHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue: ('A' | 'B')[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, v =>
					api.utils.isTypedArray(v, isListInlineEnumHeaderParamResult),
				);
...
function fnListInlineEnumHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listInlineEnumHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: ('A' | 'B')[]) => {
		try {
...
function fnListInlineEnumHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listInlineEnumHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListInlineEnumHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listInlineEnumHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: ('C' | 'D')[] | null) => {
		try {
...
function fnListMultiHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listMultiHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (valueA: RSDString[], valueB: RSDInt[], valueC: api.model.SimpleRecord[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDString);
...
function fnListMultiHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listMultiHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (valueA?: RSDString[], valueB?: RSDInt[], valueC?: api.model.SimpleRecord[]) => {
		try {
			...
			if (valueC !== undefined) {
				valueC.forEach($entry => {
					$headers.append(
						'valueC',
						encodeBase64(encodeValue(encodingType(props), api.model.SimpleRecordToJSON($entry))),
					);
				});
			}
			$init.headers = $headers;
...
function fnListMultiHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listMultiHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListMultiHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listMultiHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (valueA?: RSDString[] | null, valueB?: RSDInt[] | null, valueC?: api.model.SimpleRecord[] | null) => {
		try {
...
function fnListRecordHeaderParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listRecordHeaderParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListRecordHeaderParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listRecordHeaderParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: api.model.SimpleRecord[]) => {
		try {
...
function fnListRecordHeaderParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listRecordHeaderParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListRecordHeaderParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListHeaderParameterTypesService['listRecordHeaderParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (headerValue?: api.model.SimpleRecord[] | null) => {
		try {
