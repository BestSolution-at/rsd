...
export function createListBodyParameterTypesService(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService {
	return {
...
function fnListBooleanBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listBooleanBodyParam'] {
...
function fnListBooleanBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listBooleanBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyBoolean?: RSDBoolean[]) => {
		try {
...
function fnListBooleanBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listBooleanBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListBooleanBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listBooleanBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyBoolean?: RSDBoolean[] | null) => {
		try {
...
function fnListShortBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listShortBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListShortBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listShortBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyShort?: RSDShort[]) => {
		try {
...
function fnListShortBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listShortBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListShortBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listShortBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyShort?: RSDShort[] | null) => {
		try {
...
function fnListIntBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listIntBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListIntBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listIntBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyInt?: RSDInt[]) => {
		try {
...
function fnListIntBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listIntBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListIntBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listIntBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyInt?: RSDInt[] | null) => {
		try {
...
function fnListLongBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLongBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLongBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLongBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyLong?: RSDLong[]) => {
		try {
...
function fnListLongBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLongBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLongBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLongBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyLong?: RSDLong[] | null) => {
		try {
...
function fnListFloatBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listFloatBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListFloatBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listFloatBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyFloat?: RSDFloat[]) => {
		try {
...
function fnListFloatBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listFloatBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListFloatBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listFloatBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyFloat?: RSDFloat[] | null) => {
		try {
...
function fnListDoubleBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listDoubleBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListDoubleBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listDoubleBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyDouble?: RSDDouble[]) => {
		try {
...
function fnListDoubleBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listDoubleBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListDoubleBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listDoubleBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyDouble?: RSDDouble[] | null) => {
		try {
...
function fnListStringBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listStringBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListStringBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listStringBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyString?: RSDString[]) => {
		try {
...
function fnListStringBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listStringBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListStringBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listStringBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyString?: RSDString[] | null) => {
		try {
...
function fnListLocalDateBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalDateBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalDateBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalDateBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyLocalDate?: RSDLocalDate[]) => {
		try {
...
function fnListLocalDateBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalDateBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalDateBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalDateBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyLocalDate?: RSDLocalDate[] | null) => {
		try {
...
function fnListLocalDateTimeBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalDateTimeBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalDateTimeBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalDateTimeBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyLocalDateTime?: RSDLocalDateTime[]) => {
		try {
...
function fnListLocalDateTimeBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalDateTimeBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalDateTimeBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalDateTimeBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyLocalDateTime?: RSDLocalDateTime[] | null) => {
		try {
...
function fnListLocalTimeBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalTimeBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalTimeBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalTimeBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyLocalTime?: RSDLocalTime[]) => {
		try {
...
function fnListLocalTimeBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalTimeBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListLocalTimeBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listLocalTimeBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyLocalTime?: RSDLocalTime[] | null) => {
		try {
...
function fnListOffsetDateTimeBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listOffsetDateTimeBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyOffsetDateTime: RSDOffsetDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				...
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTimeBodyParam', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnListOffsetDateTimeBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listOffsetDateTimeBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyOffsetDateTime?: RSDOffsetDateTime[]) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTimeBodyParamOpt', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnListOffsetDateTimeBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listOffsetDateTimeBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyOffsetDateTime: RSDOffsetDateTime[] | null) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTimeBodyParamNil', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnListOffsetDateTimeBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listOffsetDateTimeBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyOffsetDateTime?: RSDOffsetDateTime[] | null) => {
		try {
			...
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
				return safeExecute(api.result.OK($data), () => onSuccess?.('listOffsetDateTimeBodyParamOptNil', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
...
function fnListZonedDateTimeBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listZonedDateTimeBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListZonedDateTimeBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listZonedDateTimeBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyZonedDateTime?: RSDZonedDateTime[]) => {
		try {
...
function fnListZonedDateTimeBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listZonedDateTimeBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListZonedDateTimeBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listZonedDateTimeBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyZonedDateTime?: RSDZonedDateTime[] | null) => {
		try {
...
function fnListScalarBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listScalarBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListScalarBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listScalarBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyScalar?: string[]) => {
		try {
...
function fnListScalarBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listScalarBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListScalarBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listScalarBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyScalar?: string[] | null) => {
		try {
...
function fnListEnumBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listEnumBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListEnumBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listEnumBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyEnum?: api.model.SampleEnum[]) => {
		try {
...
function fnListEnumBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listEnumBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListEnumBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listEnumBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyEnum?: api.model.SampleEnum[] | null) => {
		try {
...
function fnListInlineEnumBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listInlineEnumBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListInlineEnumBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listInlineEnumBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyEnum?: ('A' | 'B')[]) => {
		try {
...
function fnListInlineEnumBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listInlineEnumBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListInlineEnumBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listInlineEnumBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyEnum?: ('C' | 'D')[] | null) => {
		try {
...
function fnListMultiBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listMultiBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListMultiBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listMultiBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (valueA?: RSDString[], valueB?: RSDInt[], valueC?: api.model.SimpleRecord[]) => {
		try {
...
function fnListMultiBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listMultiBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListMultiBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listMultiBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (valueA?: RSDString[] | null, valueB?: RSDInt[] | null, valueC?: api.model.SimpleRecord[] | null) => {
		try {
...
function fnListRecordBodyParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listRecordBodyParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListRecordBodyParamOpt(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listRecordBodyParamOpt'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyRecord?: api.model.SimpleRecord[]) => {
		try {
			...
			const $body = encodeValue(
				encodingType(props),
				bodyRecord ? bodyRecord.map(api.model.SimpleRecordToJSON) : bodyRecord,
			);
			const $response = await fetchAPI($path, { ...$init, method: 'PUT', body: $body });
			if ($response.status === 200) {
				const $data = await decodeResponse($response, api.model.isNilResult);
...
function fnListRecordBodyParamNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listRecordBodyParamNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnListRecordBodyParamOptNil(
	props: ServiceProps<api.service.ErrorType>,
): api.service.ListBodyParameterTypesService['listRecordBodyParamOptNil'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (bodyRecord?: api.model.SimpleRecord[] | null) => {
		try {
