...
export function createPathParameterTypeServiceService(
	...
	return {
		...
		simpleOffsetDateTimePathParam: fnSimpleOffsetDateTimePathParam(props),
...
function fnSimpleBooleanPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleBooleanPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathBoolean: RSDBoolean) => {
		try {
...
function fnSimpleShortPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleShortPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathShort: RSDShort) => {
		try {
...
function fnSimpleIntPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleIntPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathInt: RSDInt) => {
		try {
...
function fnSimpleLongPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleLongPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathLong: RSDLong) => {
		try {
			...
			const $path = `${baseUrl}/api/pathparametertype/long/${encodeURIComponent(String(pathLong))}`;
			const $response = await fetchAPI($path, { ...$init, method: 'GET' });
...
function fnSimpleFloatPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleFloatPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathFloat: RSDFloat) => {
		try {
...
function fnSimpleDoublePathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleDoublePathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathDouble: RSDDouble) => {
		try {
...
function fnSimpleStringPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleStringPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathString: RSDString) => {
		try {
...
function fnSimpleLocalDatePathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleLocalDatePathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathLocalDate: RSDLocalDate) => {
		try {
...
function fnSimpleLocalDateTimePathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleLocalDateTimePathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathLocalDateTime: RSDLocalDateTime) => {
		try {
...
function fnSimpleLocalTimePathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleLocalTimePathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathLocalTime: RSDLocalTime) => {
		try {
...
function fnSimpleOffsetDateTimePathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleOffsetDateTimePathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathOffsetDateTime: RSDOffsetDateTime) => {
		try {
			const $init = (await preFetch?.('simpleOffsetDateTimePathParam')) ?? {};
			const $headers = new Headers($init.headers ?? {});
			$headers.append('Accept', encodingType(props));
			$headers.append('Content-Type', encodingType(props));
			$init.headers = $headers;

			const $path = `${baseUrl}/api/pathparametertype/offsetdatetime/${encodeURIComponent(pathOffsetDateTime)}`;
			const $response = await fetchAPI($path, { ...$init, method: 'GET' });

			if ($response.status === 200) {
				const $data = await decodeResponse($response, isRSDOffsetDateTime);
				return safeExecute(api.result.OK($data), () => onSuccess?.('simpleOffsetDateTimePathParam', $data));
			}
			const err = { _type: '_Status', message: await $response.text(), status: $response.status } as const;
			return api.result.ERR(err);
		} catch (e) {
			onCatch?.('simpleOffsetDateTimePathParam', e);
			const ee = e instanceof Error ? e : new Error('', { cause: e });
			const err = { _type: '_Native', message: ee.message, error: ee } as const;
			return api.result.ERR(err);
		} finally {
			final?.('simpleOffsetDateTimePathParam');
		}
	};
}

function fnSimpleZonedDateTimePathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleZonedDateTimePathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
	return async (pathZonedDateTime: RSDZonedDateTime) => {
		try {
...
function fnSimpleScalarPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleScalarPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnSimpleEnumPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['simpleEnumPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
...
function fnMultiPathParam(
	props: ServiceProps<api.service.ErrorType>,
): api.service.PathParameterTypeServiceService['multiPathParam'] {
	const { baseUrl, fetchAPI = fetch, lifecycleHandlers = {} } = props;
	const { preFetch, onSuccess, onCatch, final } = lifecycleHandlers;
