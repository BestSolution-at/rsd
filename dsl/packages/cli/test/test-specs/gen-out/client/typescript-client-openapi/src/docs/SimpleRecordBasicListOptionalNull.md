...
# SimpleRecordBasicListOptionalNull
...
```typescript
import type { SimpleRecordBasicListOptionalNull } from ''
...
} satisfies SimpleRecordBasicListOptionalNull
...
const exampleParsed = JSON.parse(exampleJSON) as SimpleRecordBasicListOptionalNull
