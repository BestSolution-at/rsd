...
```typescript
import type { SimpleRecordBasicList } from ''
...
} satisfies SimpleRecordBasicList
...
const exampleParsed = JSON.parse(exampleJSON) as SimpleRecordBasicList
