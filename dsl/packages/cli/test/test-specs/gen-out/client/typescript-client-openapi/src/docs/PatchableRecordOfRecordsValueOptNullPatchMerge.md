...
# PatchableRecordOfRecordsValueOptNullPatchMerge
...
```typescript
import type { PatchableRecordOfRecordsValueOptNullPatchMerge } from ''
...
const exampleParsed = JSON.parse(exampleJSON) as PatchableRecordOfRecordsValueOptNullPatchMerge
