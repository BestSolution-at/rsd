...
```typescript
import type { PatchableRecordBasicList } from ''
...
} satisfies PatchableRecordBasicList
...
const exampleParsed = JSON.parse(exampleJSON) as PatchableRecordBasicList
