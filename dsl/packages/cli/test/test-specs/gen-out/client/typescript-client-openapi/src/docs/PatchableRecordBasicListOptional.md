...
# PatchableRecordBasicListOptional
...
```typescript
import type { PatchableRecordBasicListOptional } from ''
...
} satisfies PatchableRecordBasicListOptional
...
const exampleParsed = JSON.parse(exampleJSON) as PatchableRecordBasicListOptional
