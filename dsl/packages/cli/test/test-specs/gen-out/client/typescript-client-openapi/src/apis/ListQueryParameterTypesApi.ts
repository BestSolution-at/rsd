...
export class ListQueryParameterTypesApi extends runtime.BaseAPI {
     ...
     * 
     */
    async apiListqueryparametertypesListInlineEnumQueryParamGetRaw(requestParameters: ApiListqueryparametertypesListInlineEnumQueryParamGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * 
     */
    async apiListqueryparametertypesListInlineEnumQueryParamGet(requestParameters: ApiListqueryparametertypesListInlineEnumQueryParamGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
