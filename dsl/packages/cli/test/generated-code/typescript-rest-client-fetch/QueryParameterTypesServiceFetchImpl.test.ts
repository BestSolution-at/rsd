...
describe('SingleQueryParameterTypesService', () => {
	...
	describe('simpleBooleanQueryParamOpt', () => {
		...
		test.each([json, msgpack])('success - optional - $encoding', async ({ service }) => {
	...
	describe('simpleShortQueryParam', () => {
		test.each([json, msgpack])('success - 12345 - $encoding', async ({ service }) => {
	...
	describe('simpleIntQueryParam', () => {
		test.each([json, msgpack])('success - 123456789 - $encoding', async ({ service }) => {
	...
	describe('simpleLongQueryParam', () => {
		test.each([json, msgpack])('success - 1234567890123 - $encoding', async ({ service }) => {
	...
	describe('simpleFloatQueryParam', () => {
		test.each([json, msgpack])('success - 12.34 - $encoding', async ({ service }) => {
	...
	describe('simpleDoubleQueryParam', () => {
		test.each([json, msgpack])('success - 12.3456789 - $encoding', async ({ service }) => {
	...
	describe('simpleStringQueryParam', () => {
		test.each([json, msgpack])('success - Hello, World! - $encoding', async ({ service }) => {
	...
	describe('simpleLocalDateQueryParam', () => {
		test.each([json, msgpack])('success - 2024-01-01 - $encoding', async ({ service }) => {
	...
	describe('simpleLocalDateTimeQueryParam', () => {
		test.each([json, msgpack])('success - 2024-01-01T12:34:56 - $encoding', async ({ service }) => {
	...
	describe('simpleZonedDateTimeQueryParam', () => {
		test.each([json, msgpack])('success - 2024-01-01T12:34:56Z - $encoding', async ({ service }) => {
	...
	describe('simpleScalarQueryParam', () => {
		test.each([json, msgpack])('success - ScalarValue - $encoding', async ({ service }) => {
	...
	describe('simpleEnumQueryParam', () => {
		test.each([json, msgpack])('success - A - $encoding', async ({ service }) => {
	...
	describe('multiQueryParam', () => {
		test.each([json, msgpack])('success - ["Hello","1"] - $encoding', async ({ service }) => {
	...
	describe('multiQueryParamOpt', () => {
		...
		test.each([json, msgpack])('success - ["hello"] - $encoding', async ({ service }) => {
	...
	describe('recordQueryParam', () => {
		test.each([json, msgpack])("success - { key: '1', version: '1', value: 'x' } - $encoding", async ({ service }) => {
