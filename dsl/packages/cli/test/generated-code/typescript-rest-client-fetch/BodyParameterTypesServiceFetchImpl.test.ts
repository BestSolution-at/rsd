...
describe('SingleBodyParameterTypesServiceFetchImpl', () => {
	describe('simpleBooleanBodyParam', () => {
		test.each([json, msgpack])('sucess true with $encoding ', async ({ service }) => {
			const [result, error] = await service.simpleBooleanBodyParam(true);
			expect(error).toBeNull();
			expect(result).toBe(true);
		});
		test.each([json, msgpack])('sucess false with $encoding ', async ({ service }) => {
	...
	describe('simpleBooleanBodyParamOpt', () => {
		test.each([json, msgpack])('sucess defined with $encoding ', async ({ service }) => {
	...
	describe('simpleLocalDateBodyParam', () => {
		test.each([json, msgpack])('success - 2023-01-01 with $encoding', async ({ service }) => {
	...
	describe('simpleLocalDateTimeBodyParam', () => {
		test.each([json, msgpack])('success - 2023-01-01T12:34:56 with $encoding', async ({ service }) => {
	...
	describe('simpleZonedDateTimeBodyParam', () => {
		test.each([json, msgpack])('success - 2023-01-01T12:34:56Z with $encoding', async ({ service }) => {
	...
	describe('simpleEnumBodyParam', () => {
		test.each([json, msgpack])('success - VALUE_A with $encoding', async ({ service }) => {
	...
	describe('multiBodyParam', () => {
		test.each([json, msgpack])('success - valueA: Hello, valueB: World with $encoding', async ({ service }) => {
	...
	describe('multiBodyParamFirst', () => {
		test.each([json, msgpack])('success - valueA: undefined, valueB: World with $encoding', async ({ service }) => {
	...
	describe('multiBodyParamOpt', () => {
		test.each([json, msgpack])('success - valueA: Hello, valueB: undefined with $encoding', async ({ service }) => {
	...
	describe('multiBodyParamNil', () => {
		test.each([json, msgpack])('success - valueA: Hello, valueB: null with $encoding', async ({ service }) => {
	...
	describe('recordBodyParam', () => {
		test.each([json, msgpack])('success - valueA: foo, valueB: 42 with $encoding', async ({ service }) => {
	...
	describe('unionBodyParam', () => {
		test.each([json, msgpack])('success - string value with $encoding', async ({ service }) => {
	...
	describe('patchableRecordBodyParam', () => {
		...
		test.each([json, msgpack])('success - key: 1, version: 1, value: undefined with $encoding', async ({ service }) => {
