...
describe('PatchableRecord_Basic_NullFromJSON', () => {
	test('simple', () => {
		expect(PatchableRecord_Basic_NullFromJSON(Simple_Json)).toStrictEqual(Simple);
		expect(PatchableRecord_Basic_NullFromJSON(SimpleNull)).toStrictEqual(SimpleNull);
	});
	test('remove-unknown', () => {
		expect(PatchableRecord_Basic_NullFromJSON(addFooProperty(Simple_Json))).toStrictEqual(Simple);
	});
	test.each(Object.keys(Simple_Json))('invalid prop $0', data => {
		expect(() => PatchableRecord_Basic_NullFromJSON(invalidateProperty(Simple_Json, data))).toThrow();
...
describe('PatchableRecord_Basic_NullToJSON', () => {
	test('simple', () => {
		expect(PatchableRecord_Basic_NullToJSON(Simple)).toStrictEqual(Simple_Json);
	...
	test('additional props', () => {
		expect(PatchableRecord_Basic_NullToJSON(addFooProperty(Simple))).toStrictEqual(Simple_Json);
...
describe('PatchableRecord_Basic_NullPatchFromJSON', () => {
	test('simple', () => {
		expect(PatchableRecord_Basic_NullPatchFromJSON(SimplePatch_Json)).toStrictEqual(SimplePatch);
	...
	test('remove-unknown', () => {
		expect(PatchableRecord_Basic_NullPatchFromJSON(addFooProperty(SimplePatch_Json))).toStrictEqual(SimplePatch);
...
describe('PatchableRecord_Basic_NullPatchToJSON', () => {
	test('simple', () => {
		expect(PatchableRecord_Basic_NullPatchToJSON(SimplePatch)).toStrictEqual(SimplePatch_Json);
	...
	test('additional props', () => {
		expect(PatchableRecord_Basic_NullPatchToJSON(addFooProperty(SimplePatch))).toStrictEqual(SimplePatch_Json);
