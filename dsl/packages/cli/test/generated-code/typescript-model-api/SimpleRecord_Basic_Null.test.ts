...
import {
	isSimpleRecord_Basic_Null,
	SimpleRecord_Basic_Null,
	SimpleRecord_Basic_NullFromJSON,
} from '../../test-specs/gen-out/client/typescript-client/src/model/SimpleRecord_Basic_Null.js';
...
describe('SimpleRecord_Basic_NullFromJSON', () => {
	test('simple', () => {
		expect(SimpleRecord_Basic_NullFromJSON(Simple_Json)).toStrictEqual(Simple);
		expect(SimpleRecord_Basic_NullFromJSON(Simple_Json)).not.toBe(Simple);
	...
	test('remove-unknown', () => {
		expect(SimpleRecord_Basic_NullFromJSON(addFooProperty(Simple_Json))).toStrictEqual(Simple);
	});
