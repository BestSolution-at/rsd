...
import {
	isSimpleRecord_Basic_Optional,
	SimpleRecord_Basic_Optional,
	SimpleRecord_Basic_OptionalFromJSON,
	SimpleRecord_Basic_OptionalToJSON,
} from '../../test-specs/gen-out/client/typescript-client/src/model/SimpleRecord_Basic_Optional.js';
...
describe('SimpleRecord_Basic_OptionalFromJSON', () => {
	test('simple', () => {
		expect(SimpleRecord_Basic_OptionalFromJSON(Simple_Json)).toStrictEqual(Simple);
		expect(SimpleRecord_Basic_OptionalFromJSON(Simple_Json)).not.toBe(Simple);
	...
	test('remove-unknown', () => {
		expect(SimpleRecord_Basic_OptionalFromJSON(addFooProperty(Simple_Json))).toStrictEqual(Simple);
	});
	test('empty object', () => {
		expect(SimpleRecord_Basic_OptionalFromJSON({})).toStrictEqual(SimpleEmpty);
	});
	...
	test.each(Object.keys(Simple))('invalid prop $0', data => {
		expect(() => SimpleRecord_Basic_OptionalFromJSON(invalidateProperty(Simple_Json, data))).toThrow();
...
describe('SimpleRecord_Basic_OptionalToJSON', () => {
	test('simple', () => {
		expect(SimpleRecord_Basic_OptionalToJSON(Simple)).toStrictEqual(Simple_Json);
	...
	test('additional props', () => {
		expect(SimpleRecord_Basic_OptionalToJSON(addFooProperty(Simple))).toStrictEqual(Simple_Json);
	});
});
