...
import {
	isPatchableRecord_Basic_List_Optional_Null,
	isPatchableRecord_Basic_List_Optional_NullPatch,
	PatchableRecord_Basic_List_Optional_Null,
	PatchableRecord_Basic_List_Optional_NullFromJSON,
	PatchableRecord_Basic_List_Optional_NullPatch,
	PatchableRecord_Basic_List_Optional_NullPatchFromJSON,
	PatchableRecord_Basic_List_Optional_NullPatchToJSON,
	PatchableRecord_Basic_List_Optional_NullToJSON,
} from '../../test-specs/gen-out/client/typescript-client/src/model/PatchableRecord_Basic_List_Optional_Null.js';
import { addFooProperty, invalidateArrayProperty, invalidateProperty, removeProperty } from './utils.js';

const Simple: PatchableRecord_Basic_List_Optional_Null = {
	key: 'key',
	version: 'version',
...
const SimpleMinimal: PatchableRecord_Basic_List_Optional_Null = {
	key: 'key',
	version: 'version',
...
const SimpleNull: PatchableRecord_Basic_List_Optional_Null = {
	key: 'key',
	version: 'version',
	valueBoolean: null,
	valueDouble: null,
...
describe('isPatchableRecord_Basic_List_Optional_Null', () => {
	test('simple', () => {
		expect(isPatchableRecord_Basic_List_Optional_Null(Simple)).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_Null(SimpleMinimal)).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_Null(SimpleNull)).toBeTruthy();
	});
	test('additional props', () => {
		expect(isPatchableRecord_Basic_List_Optional_Null(addFooProperty(Simple))).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_Null(addFooProperty(SimpleMinimal))).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_Null(addFooProperty(SimpleNull))).toBeTruthy();
	});
	test.each(Object.keys(Simple))('invalid prop $0', data => {
		expect(isPatchableRecord_Basic_List_Optional_Null(invalidateProperty(Simple, data))).toBeFalsy();
		expect(isPatchableRecord_Basic_List_Optional_Null(invalidateProperty(SimpleMinimal, data))).toBeFalsy();
		expect(isPatchableRecord_Basic_List_Optional_Null(invalidateProperty(SimpleNull, data))).toBeFalsy();
	});
});
...
describe('PatchableRecord_Basic_List_Optional_NullToJSON', () => {
	test('simple', () => {
		...
		expect(PatchableRecord_Basic_List_Optional_NullToJSON(SimpleMinimal)).not.toBe(SimpleMinimal);

		expect(PatchableRecord_Basic_List_Optional_NullToJSON(SimpleNull)).toStrictEqual(SimpleNull);
...
const SimplePatchMinimal: PatchableRecord_Basic_List_Optional_NullPatch = {
	key: 'key',
	version: 'version',
	valueBoolean: undefined,
	valueDouble: undefined,
...
const SimplePatchNull: PatchableRecord_Basic_List_Optional_NullPatch = {
	key: 'key',
	version: 'version',
	valueBoolean: null,
	valueDouble: null,
...
describe('PatchableRecord_Basic_List_Optional_NullPatchFromJSON', () => {
	...
	test('remove-unknown', () => {
		...
		expect(PatchableRecord_Basic_List_Optional_NullPatchFromJSON(addFooProperty(SimplePatchNull))).toStrictEqual(
			SimplePatchNull,
		);
	});
	test('missing key-prop', () => {
		const { withOut } = removeProperty(SimplePatchReplace, 'key');
		expect(() => PatchableRecord_Basic_List_Optional_NullPatchFromJSON(withOut)).toThrow();
	});
	...
	test.each(Object.keys(Simple))('invalid prop $0', data => {
		expect(() =>
			PatchableRecord_Basic_List_Optional_NullPatchFromJSON(invalidateProperty(SimplePatchReplace, data)),
		).toThrow();
		expect(() =>
			PatchableRecord_Basic_List_Optional_NullPatchFromJSON(invalidateProperty(SimplePatchMerge, data)),
		).toThrow();
		expect(() =>
			PatchableRecord_Basic_List_Optional_NullPatchFromJSON(invalidateProperty(SimplePatchMinimal, data)),
		).toThrow();
		expect(() =>
			PatchableRecord_Basic_List_Optional_NullPatchFromJSON(invalidateProperty(SimplePatchNull, data)),
		).toThrow();
	});
});
describe('isPatchableRecord_Basic_List_Optional_NullPatch', () => {
	test('simple', () => {
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(SimplePatchReplace)).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(SimplePatchMerge)).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(SimplePatchMinimal)).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(SimplePatchNull)).toBeTruthy();
	});
	test('additional props', () => {
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(addFooProperty(SimplePatchReplace))).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(addFooProperty(SimplePatchMerge))).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(addFooProperty(SimplePatchMinimal))).toBeTruthy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(addFooProperty(SimplePatchNull))).toBeTruthy();
	});
	test('missing key-prop', () => {
		const { withOut } = removeProperty(SimplePatchReplace, 'key');
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(withOut)).toBeFalsy();
	});
	test('missing version-prop', () => {
		const { withOut } = removeProperty(SimplePatchReplace, 'version');
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(withOut)).toBeFalsy();
	...
	test.each(Object.keys(Simple))('invalid prop $0', data => {
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(invalidateProperty(SimplePatchReplace, data))).toBeFalsy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(invalidateProperty(SimplePatchMerge, data))).toBeFalsy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(invalidateProperty(SimplePatchMinimal, data))).toBeFalsy();
		expect(isPatchableRecord_Basic_List_Optional_NullPatch(invalidateProperty(SimplePatchNull, data))).toBeFalsy();
	});
});
describe('PatchableRecord_Basic_List_Optional_NullPatchToJSON', () => {
	test('simple', () => {
		...
		expect(PatchableRecord_Basic_List_Optional_NullPatchToJSON(SimplePatchMinimal)).not.toBe(SimplePatchMinimal);

		expect(PatchableRecord_Basic_List_Optional_NullPatchToJSON(SimplePatchNull)).toStrictEqual(SimplePatchNull);
		expect(PatchableRecord_Basic_List_Optional_NullPatchToJSON(SimplePatchNull)).not.toBe(SimplePatchNull);
	});
	test('additional props', () => {
		...
		expect(PatchableRecord_Basic_List_Optional_NullPatchToJSON(addFooProperty(SimplePatchNull))).toStrictEqual(
			SimplePatchNull,
		);
	});
});
