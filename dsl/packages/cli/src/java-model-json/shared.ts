...
export function builtinSimpleJSONAccessNG(property: { type: MBuiltinType; name: string }): string {
	switch (property.type) {
		...
		case 'offset-date-time':
			return `_JsonUtils.mapOffsetDateTime(data, "${property.name}")`;
		case 'short':
...
export function builtinSimpleJSONArrayAccess(property: { type: MBuiltinType; name: string }): string {
	switch (property.type) {
		...
		case 'offset-date-time':
			return `_JsonUtils.mapOffsetDateTimes(data, "${property.name}")`;
		case 'short':
...
function builtinJSONAccessNG(property: {
	...
	switch (property.type) {
		...
		case 'offset-date-time':
			return `_JsonUtils.map${nullablePart}OffsetDateTime(data, "${property.name}")`;
		case 'short':
...
export function builtinOptJSONAccess(property: { type: MBuiltinType; name: string }): string {
	switch (property.type) {
		...
		case 'offset-date-time':
			return `_JsonUtils.mapOptOffsetDateTime(data, "${property.name}")`;
		case 'short':
...
export function builtinOptArrayJSONAccess(property: { type: MBuiltinType; name: string }): string {
	switch (property.type) {
		...
		case 'offset-date-time':
			return `_JsonUtils.mapOptOffsetDateTimes(data, "${property.name}")`;
		case 'short':
...
export function builtinNilJSONAccess(property: { type: MBuiltinType; name: string }): string {
	switch (property.type) {
		...
		case 'offset-date-time':
			return `_JsonUtils.mapNilOffsetDateTime(data, "${property.name}")`;
		case 'short':
...
export function builtinNilArrayJSONAccess(property: { type: MBuiltinType; name: string }): string {
	switch (property.type) {
		...
		case 'offset-date-time':
			return `_JsonUtils.mapNilOffsetDateTimes(data, "${property.name}")`;
		case 'short':
