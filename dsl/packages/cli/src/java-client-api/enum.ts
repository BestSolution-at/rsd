...
export function generateEnum(t: MEnumType, artifactConfig: JavaClientAPIGeneratorConfig): Artifact {
	...
	return {
		name: `${t.name}.java`,
		content: toString(generateCompilationUnit(packageName, new JavaImportsCollector(packageName), node), '\t'),
