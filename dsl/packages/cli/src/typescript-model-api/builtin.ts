...
export function generateBuiltinContent(temporalMapping: 'native' | 'string'): CompositeGeneratorNode {
	const basicBuiltin = basicBuiltinNodeTree();

	return new CompositeGeneratorNode(
		temporalMapping === 'native' ? nativeTemporalBuiltinNodeTree() : stringTemporalBuiltinNodeTree(),
		NL,
		basicBuiltin,
	);
}

function nativeTemporalBuiltinNodeTree(): CompositeGeneratorNode {
	return toNodeTree(`
...
function stringTemporalBuiltinNodeTree(): CompositeGeneratorNode {
	return toNodeTree(`
...
function basicBuiltinNodeTree(): CompositeGeneratorNode {
	return toNodeTree(`
