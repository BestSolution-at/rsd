...
import { isTypescriptClientAPIGeneratorConfig, TypescriptClientAPIGeneratorConfig } from '../typescript-gen-utils.js';
...
function generateType(t: MResolvedUserType, config: TypescriptClientAPIGeneratorConfig): Artifact | undefined {
	if (isMRecordType(t)) {
