...
import { JavaImportsCollector, JavaServerGeneratorConfig, generateCompilationUnit, toPath } from '../java-gen-utils.js';
...
export function generateUnion(t: MResolvedUnionType, artifactConfig: JavaServerGeneratorConfig): Artifact {
