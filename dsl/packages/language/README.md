...
- [src/remote-service-description.langium](src/remote-service-description.langium) -  The grammar definition of your language
- [src/remote-service-description-module.ts](src/remote-service-description-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/remote-service-description-validator.ts](src/remote-service-description-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/remote-service-description.monarch.ts](src/syntaxes/remote-service-description.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/remote-service-description.tmLanguage.json](syntaxes/remote-service-description.tmLanguage.json) - Textmate based syntax highlighting instructions.
