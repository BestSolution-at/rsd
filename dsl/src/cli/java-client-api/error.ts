...
export function generateError(t: MError, artifactConfig: JavaClientAPIGeneratorConfig): Artifact {
    ...
    return {
        ...
        content: toString(generateCompilationUnit(packageName, importCollector, generateSource(t, artifactConfig, fqn))),
        path: toPath(artifactConfig.targetFolder, packageName)
    };
}

function generateSource(t: MError, artifactConfig: JavaClientAPIGeneratorConfig, fqn: (type: string) => string): CompositeGeneratorNode {
