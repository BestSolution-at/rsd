...
import dev.rsdlang.person.client.spi.PersonClientFactory;

/**
 * <p>
 * Client interface for the PersonClient API. It provides methods to create
...
public interface PersonClient {
	/**
	 * Creates a new instance of the PersonClient using the provided base URL.
	 * 
	 * <p>
	 * The service loader is used to load the implementation of the
	 * PersonClientFactory, which is responsible for creating instances of the
	 * PersonClient.
	 * </p>
	 *
	 * @param baseURL the base URL of the API
	 * @return a new instance of PersonClient
	 */
	public static PersonClient create(URI baseURL) {
		return ServiceLoader.load(PersonClientFactory.class).iterator().next().create(baseURL);
	}
