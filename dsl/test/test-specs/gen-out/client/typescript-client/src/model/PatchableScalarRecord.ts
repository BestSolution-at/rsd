...
import { checkOptProp, checkProp, createTypedArrayGuard, isNull, isRecord, isString, type ListMergeAddRemove, type ListReplace, propListValue, propValue } from '../_type-utils.js';
...
export function isPatchableScalarRecordPatch(value: unknown): value is PatchableScalarRecordPatch {
	return isRecord(value) &&
		...
		(isNull(value.value_Null) || checkOptProp(value, 'value_Null', isString)) &&
		(isNull(value.value_Opt) || checkOptProp(value, 'value_Opt', isString)) &&
		(isNull(value.value_Opt_Null) || checkOptProp(value, 'value_Opt_Null', isString)) &&
		checkOptProp(value, 'list', createTypedArrayGuard(isString)) &&
		(isNull(value.list_Null) || checkOptProp(value, 'list_Null', createTypedArrayGuard(isString))) &&
		(isNull(value.list_Opt) || checkOptProp(value, 'list_Opt', createTypedArrayGuard(isString))) &&
		(isNull(value.list_Opt_Null) || checkOptProp(value, 'list_Opt_Null', createTypedArrayGuard(isString)));
}
