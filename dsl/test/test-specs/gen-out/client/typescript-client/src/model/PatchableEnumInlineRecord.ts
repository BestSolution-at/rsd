...
export function isPatchableEnumInlineRecord(value: unknown): value is PatchableEnumInlineRecord {
	return isRecord(value) &&
		...
		(isNull(value.value_Null) || checkProp(value, 'value_Null', isPatchableEnumInlineRecord_Value_Null)) &&
		checkOptProp(value, 'value_Opt', isPatchableEnumInlineRecord_Value_Opt) &&
		(isNull(value.value_Opt_Null) || checkOptProp(value, 'value_Opt_Null', isPatchableEnumInlineRecord_Value_Opt_Null)) &&
		checkProp(value, 'list', createTypedArrayGuard(isPatchableEnumInlineRecord_List)) &&
		(isNull(value.list_Null) || checkProp(value, 'list_Null', createTypedArrayGuard(isPatchableEnumInlineRecord_List_Null))) &&
		(isNull(value.list_Opt_Null) || checkOptProp(value, 'list_Opt_Null', createTypedArrayGuard(isPatchableEnumInlineRecord_List_Opt_Null)));
}
...
export function isPatchableEnumInlineRecordPatch(value: unknown): value is PatchableEnumInlineRecordPatch {
	return isRecord(value) &&
		...
		(isNull(value.value_Null) || checkOptProp(value, 'value_Null', isPatchableEnumInlineRecord_Value_Null)) &&
		(isNull(value.value_Opt) || checkOptProp(value, 'value_Opt', isPatchableEnumInlineRecord_Value_Opt)) &&
		(isNull(value.value_Opt_Null) || checkOptProp(value, 'value_Opt_Null', isPatchableEnumInlineRecord_Value_Opt_Null)) &&
		checkOptProp(value, 'list', createTypedArrayGuard(isPatchableEnumInlineRecord_List)) &&
		(isNull(value.list_Null) || checkOptProp(value, 'list_Null', createTypedArrayGuard(isPatchableEnumInlineRecord_List_Null))) &&
		(isNull(value.list_Opt_Null) || checkOptProp(value, 'list_Opt_Null', createTypedArrayGuard(isPatchableEnumInlineRecord_List_Opt_Null)));
}
...
export function PatchableEnumInlineRecordPatchFromJSON($value: Record<string, unknown>): PatchableEnumInlineRecordPatch {
	...
	const value_Opt_Null = propValue('value_Opt_Null', $value, isPatchableEnumInlineRecord_Value_Opt_Null, 'optional_null');
	const list = propListValue('list', $value, isPatchableEnumInlineRecord_List, 'optional');
	const list_Null = propListValue('list_Null', $value, isPatchableEnumInlineRecord_List_Null, 'optional_null');
	const list_Opt_Null = propListValue('list_Opt_Null', $value, isPatchableEnumInlineRecord_List_Opt_Null, 'optional_null');
	return {
		value,
		value_Null,
