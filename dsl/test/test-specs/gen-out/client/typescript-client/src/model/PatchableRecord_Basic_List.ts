...
import { checkOptProp, checkProp, createReplaceAddRemoveGuard, createTypedArrayGuard, isBoolean, isNumber, isRecord, isString, type ListMergeAddRemove, ListMergeAddRemoveFromJSON, type ListReplace, noopMap, propListValue, propMappedValue, propValue } from '../_type-utils.js';
...
export function isPatchableRecord_Basic_List(value: unknown): value is PatchableRecord_Basic_List {
	return isRecord(value) && checkProp(value, 'key', isString) && checkProp(value, 'version', isString) && checkProp(value, 'valueBoolean', createTypedArrayGuard(isBoolean)) && checkProp(value, 'valueShort', createTypedArrayGuard(isNumber)) && checkProp(value, 'valueInt', createTypedArrayGuard(isNumber)) && checkProp(value, 'valueLong', createTypedArrayGuard(isNumber)) && checkProp(value, 'valueFloat', createTypedArrayGuard(isNumber)) && checkProp(value, 'valueDouble', createTypedArrayGuard(isNumber)) && checkProp(value, 'valueString', createTypedArrayGuard(isString)) && checkProp(value, 'valueLocalDate', createTypedArrayGuard(isString)) && checkProp(value, 'valueLocalDateTime', createTypedArrayGuard(isString)) && checkProp(value, 'valueZonedDateTime', createTypedArrayGuard(isString));
}
...
export function isPatchableRecord_Basic_ListPatch(value: unknown): value is PatchableRecord_Basic_ListPatch {
	return isRecord(value) && checkProp(value, 'key', isString) && checkProp(value, 'version', isString) && checkOptProp(value, 'valueBoolean', createReplaceAddRemoveGuard(isBoolean)) && checkOptProp(value, 'valueShort', createReplaceAddRemoveGuard(isNumber)) && checkOptProp(value, 'valueInt', createReplaceAddRemoveGuard(isNumber)) && checkOptProp(value, 'valueLong', createReplaceAddRemoveGuard(isNumber)) && checkOptProp(value, 'valueFloat', createReplaceAddRemoveGuard(isNumber)) && checkOptProp(value, 'valueDouble', createReplaceAddRemoveGuard(isNumber)) && checkOptProp(value, 'valueString', createReplaceAddRemoveGuard(isString)) && checkOptProp(value, 'valueLocalDate', createReplaceAddRemoveGuard(isString)) && checkOptProp(value, 'valueLocalDateTime', createReplaceAddRemoveGuard(isString)) && checkOptProp(value, 'valueZonedDateTime', createReplaceAddRemoveGuard(isString));
}
