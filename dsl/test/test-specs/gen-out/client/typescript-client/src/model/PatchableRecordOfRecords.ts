...
import { isPatchableRecord_Basic, isPatchableRecord_BasicPatch, type PatchableRecord_Basic, PatchableRecord_BasicFromJSON, type PatchableRecord_BasicPatch, PatchableRecord_BasicPatchFromJSON, PatchableRecord_BasicToJSON } from './PatchableRecord_Basic.js';
import { checkOptProp, checkProp, createReplaceAddUpdateRemoveGuard, createTypedArrayGuard, isMerge, isNull, isRecord, isReplace, isString, isUndefined, ListMergeAddRemoveFromJSON, type ListMergeAddUpdateRemove, ListMergeAddUpdateRemoveFromJSON, type ListReplace, type Merge, noopMap, propMappedListValue, propMappedValue, propValue, type Replace, ReplaceOrMergeFromJSON } from '../_type-utils.js';
...
export function isPatchableRecordOfRecords(value: unknown): value is PatchableRecordOfRecords {
	return isRecord(value) && checkProp(value, 'key', isString) && checkProp(value, 'version', isString) && checkProp(value, 'value', isPatchableRecord_Basic) && (checkProp(value, 'value_Null', isNull) || checkProp(value, 'value_Null', isPatchableRecord_Basic)) && checkOptProp(value, 'value_Opt', isPatchableRecord_Basic) && (checkOptProp(value, 'value_Opt_Null', isNull) || checkOptProp(value, 'value_Opt_Null', isPatchableRecord_Basic)) && checkProp(value, 'list', createTypedArrayGuard(isPatchableRecord_Basic)) && (checkProp(value, 'list_Null', isNull) || checkProp(value, 'list_Null', createTypedArrayGuard(isPatchableRecord_Basic))) && checkOptProp(value, 'list_Opt', createTypedArrayGuard(isPatchableRecord_Basic)) && (checkOptProp(value, 'list_Opt_Null', isNull) || checkOptProp(value, 'list_Opt_Null', createTypedArrayGuard(isPatchableRecord_Basic)));
}
...
export function isPatchableRecordOfRecordsPatch(value: unknown): value is PatchableRecordOfRecordsPatch {
	return isRecord(value) && checkProp(value, 'key', isString) && checkProp(value, 'version', isString) && checkOptProp(value, 'value', isValuePatch) && (checkOptProp(value, 'value_Null', isNull) || checkOptProp(value, 'value_Null', isValue_NullPatch)) && (checkOptProp(value, 'value_Opt', isNull) || checkOptProp(value, 'value_Opt', isValue_OptPatch)) && (checkOptProp(value, 'value_Opt_Null', isNull) || checkOptProp(value, 'value_Opt_Null', isValue_Opt_NullPatch)) && checkOptProp(value, 'list', createReplaceAddUpdateRemoveGuard(isPatchableRecord_Basic, isPatchableRecord_BasicPatch, isString)) && (checkOptProp(value, 'list_Null', isNull) || checkOptProp(value, 'list_Null', createReplaceAddUpdateRemoveGuard(isPatchableRecord_Basic, isPatchableRecord_BasicPatch, isString))) && (checkOptProp(value, 'list_Opt', isNull) || checkOptProp(value, 'list_Opt', createReplaceAddUpdateRemoveGuard(isPatchableRecord_Basic, isPatchableRecord_BasicPatch, isString))) && (checkOptProp(value, 'list_Opt_Null', isNull) || checkOptProp(value, 'list_Opt_Null', createReplaceAddUpdateRemoveGuard(isPatchableRecord_Basic, isPatchableRecord_BasicPatch, isString)));
}
