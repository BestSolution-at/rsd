...
import { isPatchableUnion, isPatchableUnionPatch, type PatchableUnion, PatchableUnionFromJSON, type PatchableUnionPatch, PatchableUnionPatchFromJSON, PatchableUnionPatchToJSON, PatchableUnionToJSON } from './PatchableUnion.js';
import { checkOptProp, checkProp, createListMergeUpdateRemoveToJSON, createListReplaceToJSON, createReplaceAddUpdateRemoveGuard, createTypedArrayGuard, isNull, isRecord, isString, isUndefined, type ListMergeAddUpdateRemove, ListMergeAddUpdateRemoveFromJSON, type ListReplace, noopMap, propMappedListValue, propMappedValue, propValue, ReplaceOrMergeToJSON } from '../_type-utils.js';
...
export function PatchableRecordWithUnionPatchToJSON($value: PatchableRecordWithUnionPatch): Record<string, unknown> {
	const key = $value.key;
	const version = $value.version;
	const value = isUndefined($value.value) ? undefined : ReplaceOrMergeToJSON($value.value, PatchableUnionToJSON, PatchableUnionPatchToJSON);
	const value_Null = isUndefined($value.value_Null) || isNull($value.value_Null) ? $value.value_Null : ReplaceOrMergeToJSON($value.value_Null, PatchableUnionToJSON, PatchableUnionPatchToJSON);
	const value_Opt = isUndefined($value.value_Opt) || isNull($value.value_Opt) ? $value.value_Opt : ReplaceOrMergeToJSON($value.value_Opt, PatchableUnionToJSON, PatchableUnionPatchToJSON);
	const value_Opt_Null = isUndefined($value.value_Opt_Null) || isNull($value.value_Opt_Null) ? $value.value_Opt_Null : ReplaceOrMergeToJSON($value.value_Opt_Null, PatchableUnionToJSON, PatchableUnionPatchToJSON);
