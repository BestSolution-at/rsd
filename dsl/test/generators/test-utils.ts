...
import { MResolvedRSDModel, resolve } from '../../src/cli/model.js';
import { TypescriptClientAPIGeneratorConfig } from '../../src/cli/typescript-gen-utils.js';
...
export function findListElement<T>(list: ReadonlyArray<unknown>, typeGuard: (v: unknown) => v is T, predicate: (r: T) => boolean): T {
