      ...
      <Fragment>
        <div class="flex flex-grow lg:ml-72 xl:ml-80">
          <header class="contents lg:fixed lg:inset-0 lg:flex lg:pointer-events-none">
            <div class="contents lg:block lg:w-72 xl:w-80 border-zinc-900/10 lg:border-r lg:overflow-y-auto bg-gray-50 lg:pointer-events-auto lg:px-6 lg:pt-4 lg:pb-8 lg:dark:border-white/10">
              <div class="hidden lg:block">
                <a class="text-xl font-bold" href="#home">
                  {this.projectname}
                </a>
              </div>
              <div class="items-center gap-12 justify-between px-4 sm:px-6 lg:px-8 fixed inset-0 h-14 lg:left-72 xl:left-80 backdrop-blur-xs border-b border-zinc-900/10 bg-white/60 flex">
                <div class="lg:hidden">
                  <a class="text-xl font-bold" href="#home">
                    {this.projectname}
                  </a>
                ...
                <div class="hidden lg:block lg:max-w-md lg:flex-auto">
                  <button class="hidden h-8 w-full items-center gap-2 rounded-full bg-white pr-3 pl-2 text-sm text-zinc-500 ring-1 ring-zinc-900/10 transition hover:ring-zinc-900/20 lg:flex dark:bg-white/5 dark:text-zinc-400 dark:ring-white/10 dark:ring-inset dark:hover:ring-white/20">
